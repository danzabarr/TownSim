...
public static class Ballistics
{
    ...
    public delegate bool Traverse(Vector3 p0, Vector3 p1);

    public static void Arc(Vector3 origin, Vector3 velocity, float drag, float increment, int iterations, Traverse t)
    {
        Vector3 p0 = origin;
        ...
        for (int i = 0; i < iterations; i++)
        {
            ...
            velocity *= 1 - increment * drag;// Mathf.Pow(drag, visualTimeStep);
            Vector3 p1 = p0 + velocity * increment;
